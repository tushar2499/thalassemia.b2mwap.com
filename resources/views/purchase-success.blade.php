...
<body>
    ...
    <div id="ticket-visual"
        ...
        <div
            ...
            <span id="ticket_no">{{ $ticketNo }}</span>
        </div>
        <div
            ...
            <span id="token_no">Unique User ID: {{ $tokenNo->token }}</span>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.download-btn').click(async function(e) {
                e.preventDefault();
                ...
                try {
                    ...
                    console.error("Canvas error on ticket: ", error);
                }
