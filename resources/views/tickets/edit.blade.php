        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text"
                       ...
                       id="ticket_no"
                       name="ticket_no"
                       value="{{ old('ticket_no', $ticket->ticket_no) }}"
                       required
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number"
                       ...
                       id="reference_no"
                       name="reference_no"
                       value="{{ old('reference_no', $ticket->reference_no) }}"
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select @error('sold_status') is-invalid @enderror"
                        ...
                        name="sold_status"
                        required>
                    <option value="0" {{ old('sold_status', $ticket->sold_status) == 0 ? 'selected' : '' }}>Unsold</option>
                    <option value="1" {{ old('sold_status', $ticket->sold_status) == 1 ? 'selected' : '' }}>Sold</option>
                </select>
                @error('sold_status')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="datetime-local"
                       ...
                       id="sold_date"
                       name="sold_date"
                       value="{{ old('sold_date', $ticket->sold_date ? $ticket->sold_date->format('Y-m-d\TH:i') : '') }}">
                @error('sold_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
